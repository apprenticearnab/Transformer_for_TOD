...
Original file is located at
    https://colab.research.google.com/drive/16QqjBBzqG2_2mpY4lmcmHawjcmMlCXMc
"""

#Optional cell
'''import os
os.chdir("/content/drive/My Drive/simpletod")'''
...
class EncoderDecoder(nn.Module):
    ...
    def forward_belief_action(self, src, tgt_belief, src_mask, tgt_mask,tgt_action,tgt1_mask):
        self.forward_encoded = self.encode(src,src_mask)
        "Take in and process masked src and target sequences."
        return self.decode_belief(self.forward_encoded, src_mask,
                            tgt_belief, tgt_mask) , self.decode_action(self.forward_encoded,src_mask,tgt_action,tgt1_mask)
    
    #def forward_action(self, src, tgt_action, src_mask, tgt_mask):
        "Take in and process masked src and target sequences."
        #return self.decode_action(self.forward_encoded,src_mask,tgt_action,tgt_mask)
